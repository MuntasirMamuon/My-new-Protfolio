      ...
      <div className="navbar bg-none md:px-32 py-6 items-end">
        <div className="navbar-start">
          <div className="">
            <label
              onClick={HandleClick}
              className="btn relative btn-ghost lg:hidden"
            >
              <svg
            ...
            <span className="absolute top-3">
              ...
              >
                ...
                <span class="text-5xl font-bold text-secondary">folio</span>
              </a>
            </span>
            {open && (
              <ul className=" lg:hidden menu menu-compact dropdown-content mt-8  p-2 shadow bg-primary border border-secondary rounded-box w-52 py-10">
                <li className="hover:text-secondary mx-auto">
                ...
                <span class="my-5 text-secondary mx-auto font-bold text-3xl">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    stroke-width="0"
                ...
                <div className="flex justify-center items-center">
                  <li className="rounded-full hover:text-secondary">
                    <Link
                      ...
                      to="https://github.com/MuntasirMamuon"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
                  ...
                  <li class="rounded-full hover:text-secondary">
                    <Link
                      className="rounded-full"
                      to="https://www.linkedin.com/in/mohammadmuntasirmamun/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
                  ...
                  <li className="rounded-full hover:text-secondary">
                    <Link
                      className="rounded-full"
                      to="https://www.facebook.com/muntasirislam01"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
          ...
          <a
            ...
            href="/"
          >
            <img className="w-16" src="https://i.ibb.co/jHbyW2c/p.png" alt="" />
            <span className="text-5xl font-bold">ort</span>
            <span class="text-5xl font-bold text-secondary">folio</span>
          </a>
        </div>
        <div className="navbar-center hidden lg:flex items-center ">
          <ul className="menu menu-horizontal px-1 items-center">
            <li className="hover:text-secondary px-1">
